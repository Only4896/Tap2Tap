...
public class GamePage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scores3 = intent.getIntExtra("Scores", 0);
            ...
            circleView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v == currentHighlightedView) {
                        ...
                        highlightRandomView();
                        scores3++;
                        TextView tv = (TextView) findViewById(R.id.scores3);
                        tv.setText("Scores: " + scores3);
                    }
        ...
        timer = new CountDownTimer(6000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(GamePage3.this, "Time is up!", Toast.LENGTH_SHORT).show();
            }
        }.start();

        //Level 4 button
        Button lvl4button = findViewById(R.id.ContinueButton);
        lvl4button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GamePage3.this, GamePage4.class);
                intent.putExtra("Scores", scores3);
        ...
        exitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (scoresList.indexOf(userScore) <= 24) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(GamePage3.this);
                    builder.setTitle("Congratulations! Please enter your name...");

                    // Set up the layout for the dialog box
                    LinearLayout layout = new LinearLayout(GamePage3.this);
                    layout.setOrientation(LinearLayout.VERTICAL);

                    // Add an edit text for the user to enter their name
                    final EditText nameEditText = new EditText(GamePage3.this);
                    nameEditText.setHint("Name");
                    layout.addView(nameEditText);

                    // Show the user's score in the dialog box
                    TextView scoreTextView = new TextView(GamePage3.this);
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            AlertDialog.Builder scoreTableBuilder = new AlertDialog.Builder(GamePage3.this);
                            ...
                            scoreTableBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    Intent intent = new Intent(GamePage3.this, MainActivity.class);
                                    startActivity(intent);
                                }
                            });
