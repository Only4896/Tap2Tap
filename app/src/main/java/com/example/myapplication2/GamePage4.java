...
public class GamePage4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scores4 = intent.getIntExtra("Scores", 0);
            ...
            circleView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v == currentHighlightedView) {
                        ...
                        highlightRandomView();
                        scores4++;
                        TextView tv = (TextView) findViewById(R.id.scores4);
                        tv.setText("Scores: " + scores4);
                    }
        ...
        timer = new CountDownTimer(6000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(GamePage4.this, "Time is up!", Toast.LENGTH_SHORT).show();
            }
        }.start();
        ...
        lvl4button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Scores", scores4);
        ...
        exitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (scoresList.indexOf(userScore) <= 24) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(GamePage4.this);
                    builder.setTitle("Congratulations! Please enter your name...");

                    // Set up the layout for the dialog box
                    LinearLayout layout = new LinearLayout(GamePage4.this);
                    layout.setOrientation(LinearLayout.VERTICAL);

                    // Add an edit text for the user to enter their name
                    final EditText nameEditText = new EditText(GamePage4.this);
                    nameEditText.setHint("Name");
                    layout.addView(nameEditText);

                    // Show the user's score in the dialog box
                    TextView scoreTextView = new TextView(GamePage4.this);
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            AlertDialog.Builder scoreTableBuilder = new AlertDialog.Builder(GamePage4.this);
                            ...
                            scoreTableBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    Intent intent = new Intent(GamePage4.this, MainActivity.class);
                                    startActivity(intent);
                                }
                            });
