...
public class GamePage2 extends AppCompatActivity {
    ...
    //Intent intentSco = getIntent();
    //int scores2 = intentSco.getIntExtra("Scores", 0);
    int scores2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scores2 = intent.getIntExtra("Scores", 0);
            ...
            circleView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v == currentHighlightedView) {
                        ...
                        highlightRandomView();
                        scores2++;
                        TextView tv = (TextView) findViewById(R.id.scores2);
                        tv.setText("Scores: " + scores2);
                    }
        ...
        timer = new CountDownTimer(6000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(GamePage2.this, "Time is up!", Toast.LENGTH_SHORT).show();
            }
        }.start();

        //Level 3 button
        Button lvl3button = findViewById(R.id.ContinueButton);
        lvl3button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GamePage2.this, GamePage3.class);
                intent.putExtra("Scores", scores2);
        ...
        exitbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (scoresList.indexOf(userScore) <= 24) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(GamePage2.this);
                    builder.setTitle("Congratulations! Please enter your name...");

                    // Set up the layout for the dialog box
                    LinearLayout layout = new LinearLayout(GamePage2.this);
                    layout.setOrientation(LinearLayout.VERTICAL);

                    // Add an edit text for the user to enter their name
                    final EditText nameEditText = new EditText(GamePage2.this);
                    nameEditText.setHint("Name");
                    layout.addView(nameEditText);

                    // Show the user's score in the dialog box
                    TextView scoreTextView = new TextView(GamePage2.this);
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            AlertDialog.Builder scoreTableBuilder = new AlertDialog.Builder(GamePage2.this);
                            ...
                            scoreTableBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    Intent intent = new Intent(GamePage2.this, MainActivity.class);
                                    startActivity(intent);
                                }
                            });
